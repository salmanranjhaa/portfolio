...
Something shifted when the framing changed. Students stopped doing the minimum required to satisfy the brief and started going beyond it, because they were invested in the thing they were building, not just the grade attached to it. And the way the course picks its best work makes that hard to fake. Twelve to thirteen exercise classes run in parallel, each with around ten projects. Every TA reviews their own class and forwards a single project; the professors then review that shortlist and select three to present in the main lecture, in front of roughly 500 students, who vote on the winner. For two semesters in a row, the project from my class came first. Not shortlisted, not among the best: first, by the vote of the cohort itself.
